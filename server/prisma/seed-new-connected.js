...
async function main() {
  console.log('🌱 Starting highly connected seed of 500 Students and 50 Teachers...');
  ...
  // Since there are 12 classes and 50 teachers, assign the first 12 teachers as class teachers
  ...
  for (let i = 0; i < dbSubjects.length; i++) {
    // Randomly assign one of the 50 teachers to each subject
