...
url = "https://bstevdkjqjzaglayicdg.supabase.co/rest/v1/Teacher?select=id,userId,User(email,firstName,lastName)"
r = requests.get(url, headers=headers)
print("All teachers:")
for t in r.json():
    u = t.get('User') or {}
    print(f"Teacher ID: {t.get('id')}, UserID: {t.get('userId')}, Email: {u.get('email')}, Name: {u.get('firstName')} {u.get('lastName')}")
