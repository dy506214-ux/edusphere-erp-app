...
url = "https://bstevdkjqjzaglayicdg.supabase.co/rest/v1/TimetableSlot?select=*,Subject(name),Section(name,Class(name)),Teacher(id,User(firstName,lastName))&limit=5"
headers = {
