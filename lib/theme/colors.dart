...
const Map<String, RoleTheme> roleThemes = {
  ...
  'transport': RoleTheme(primary: AppColors.transportPrimary, dark: AppColors.transportDark, light: AppColors.transportLight, label: 'Transport',       icon: Icons.directions_bus_rounded),
  'accountant': RoleTheme(primary: AppColors.accountantPrimary, dark: AppColors.accountantDark, light: AppColors.accountantLight, label: 'Accountant',     icon: Icons.account_balance_wallet_rounded),
};
