...
class TimetableScreen extends StatefulWidget {
  ...
  const TimetableScreen(
      {super.key, required this.primaryColor, required this.gradient});
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.videocam_rounded,
                color: Colors.red.shade400, size: 32.sp),
          ),
          SizedBox(height: 16.h),
          Text(_joining!['subject'],
              style: AppTypography.h4.copyWith(color: AppColors.textDark)),
          Text('${_joining!['teacher']} • ${_joining!['room']}',
              style:
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: Colors.red.shade50,
                borderRadius: BorderRadius.circular(12.r)),
            child: Text('🔴 LIVE NOW • 38 students joined',
                ...
                Future.delayed(const Duration(milliseconds: 1500), () {
                  if (mounted) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: const Text('Joined live class!'),
          ...
          TextButton(
              onPressed: () => setState(() => _joining = null),
              child: Text('Cancel',
