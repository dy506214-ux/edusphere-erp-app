            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                          child: Column(
                              ...
                              children: [
                            _inputLabel('Class'),
                            _dropdown(['Grade 12A', 'Grade 11B', 'Grade 10C'])
                          ])),
                      SizedBox(width: 16.w),
                      Expanded(
                          child: Column(
                  ...
                  _textArea(
                      'Solve NCERT Exercise 10.1 to 10.5. Show all steps clearly.'),
                  SizedBox(height: 16.h),
                  _inputLabel('Notify via'),
                  Row(
                    children: [
                      _checkbox('App', notifyApp,
                          (v) => setState(() => notifyApp = v!)),
                      _checkbox('WhatsApp', notifyWhatsApp,
                          (v) => setState(() => notifyWhatsApp = v!)),
                      _checkbox('Email', notifyEmail,
                  ...
                  _buildPrimaryButton(
                      'Assign Homework', () => Navigator.pop(context)),
  ...
  Widget _checkbox(String label, bool value, Function(bool?) onChanged) {
    return Row(
      children: [
        ...
        Text(label, style: AppTypography.small.copyWith(color: darkNavy)),
        SizedBox(width: 8.w),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 8.h),
          Text('Upload PDF / Worksheet',
              style: AppTypography.small.copyWith(color: Colors.grey.shade400)),
        ],
      ),
    );
  }
